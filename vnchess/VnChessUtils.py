...
def get_all_actions(_prev_board, _board, _player_num):
    ...
    if is_possibility_trap and active_position is not None and prev_position:
        all_actions = get_traps(_board, _player_num, prev_position)
...
if __name__ == "__main__":
    ...
    print(moves)
    print(is_valid_move(prev_board,board,-1,((4,3),(3,3))))
    print(is_valid_move(prev_board,board,-1,((4,3),(3,2))))
    print(is_valid_move(prev_board,board,-1,((0,0),(1,1))))
